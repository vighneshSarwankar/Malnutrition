...
public class TableData
{
    ...
    public static abstract class Child_Profile implements BaseColumns {
        ...
        public static void putInformation(DatabaseOperations dop,String id,String name, String age, String gender, String mothername, String village, String district, String contactno) {
